...
export const categories: Category[] = [
  { 
    ...
    slug: 'construction',
    subcategories: [
      { id: 'sub-1', name: 'Varnishes & Paints', slug: 'paints-varnishes', imageUrl: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=300&h=300&fit=crop' },
      { id: 'sub-2', name: 'Insulation Materials', slug: 'insulation-materials', imageUrl: 'https://images.unsplash.com/photo-1620055152862-ec7f0b5eddf4?w=300&h=300&fit=crop' },
      { id: 'sub-3', name: 'Roofing & Facade Systems', slug: 'roofing-facade', imageUrl: 'https://images.unsplash.com/photo-1633420804561-39656461c390?w=300&h=300&fit=crop' },
      { id: 'sub-4', name: 'Formwork & Wood Systems', slug: 'wood-systems', imageUrl: 'https://images.unsplash.com/photo-1585741980753-40394b0c3a54?w=300&h=300&fit=crop' },
      { id: 'sub-5', name: 'Construction Powders', slug: 'construction-powders', imageUrl: 'https://images.unsplash.com/photo-1541888946425-d81bb19480c5?w=300&h=300&fit=crop' },
      { id: 'sub-6', name: 'Construction & Gypsum Boards', slug: 'construction-boards', imageUrl: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=300&h=300&fit=crop' },
      { id: 'sub-7', name: 'Bricks & Blocks', slug: 'bricks-blocks', imageUrl: 'https://images.unsplash.com/photo-1523413555809-0fb8a4a2c71a?w=300&h=300&fit=crop' },
      { id: 'sub-8', name: 'Consumables', slug: 'consumables', imageUrl: 'https://images.unsplash.com/photo-1581147036324-c17da42ef5e0?w=300&h=300&fit=crop' },
      { id: 'sub-9', name: 'Adhesives & Sealants', slug: 'adhesives-sealants', imageUrl: 'https://images.unsplash.com/photo-1563214591-e4905324316d?w=300&h=300&fit=crop' },
      { id: 'sub-10', name: 'Construction Profiles & Accessories', slug: 'profiles-accessories', imageUrl: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=300&h=300&fit=crop' },
      { id: 'sub-11', name: 'Construction Liquids & Solutions', slug: 'liquids-solutions', imageUrl: 'https://images.unsplash.com/photo-1516937941344-00b4e0337589?w=300&h=300&fit=crop' },
      { id: 'sub-12', name: 'Warehouse Products', slug: 'warehouse-products', imageUrl: 'https://images.unsplash.com/photo-1553413077-190dd305871c?w=300&h=300&fit=crop' },
      { id: 'sub-13', name: 'Stair Treads & Railings', slug: 'stairs-railings', imageUrl: 'https://images.unsplash.com/photo-1505330622279-bf7d7fc918f4?w=300&h=300&fit=crop' },
    ]
  },
