...
export const categories: Category[] = [
  { 
    ...
    slug: 'construction',
    subcategories: [
      { id: 'sub-1', name: 'Varnishes & Paints', slug: 'paints-varnishes', imageUrl: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&h=400&fit=crop' },
      { id: 'sub-2', name: 'Insulation Materials', slug: 'insulation-materials', imageUrl: 'https://images.unsplash.com/photo-1620055152862-ec7f0b5eddf4?w=400&h=400&fit=crop' },
      { id: 'sub-3', name: 'Roofing & Facade Systems', slug: 'roofing-facade', imageUrl: 'https://images.unsplash.com/photo-1633420804561-39656461c390?w=400&h=400&fit=crop' },
